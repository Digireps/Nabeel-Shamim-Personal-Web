        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-card rounded-2xl p-8 md:p-12 border border-border text-center">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <p className="text-xl md:text-2xl leading-relaxed text-foreground font-['Outfit'] font-light mb-8 min-h-[6rem]">
                  "{t.quote}"
                </p>
                <div className="w-14 h-14 rounded-full mx-auto mb-4 flex items-center justify-center accent-block text-primary-foreground font-bold font-['Outfit'] text-lg">
                  {t.name[0]}
                </div>
                <p className="font-semibold font-['Outfit'] text-foreground">{t.name}</p>
