  ...
  return (
    <section id="introduction" className="py-24 md:py-32 relative">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-[1fr_2fr] gap-12 items-start">
        <motion.div {...fadeIn}>
          <h2 className="text-massive font-black font-['Outfit'] uppercase tracking-tight text-muted/80 mb-4 select-none">
            Intro
          </h2>
          <p className="text-sm uppercase tracking-[0.3em] text-primary font-semibold mb-2">
            Introduction
          </p>
          <div className="w-16 h-0.5 line-accent" />
        </motion.div>
        ...
        <div className="grid md:grid-cols-[2fr_1fr] gap-10 items-start">
          <motion.div {...fadeIn} transition={{ duration: 0.6, delay: 0.1 }}>
            ...
            <Button
              variant="outline"
              className="border-primary text-primary hover:bg-primary hover:text-primary-foreground rounded-full px-8 uppercase tracking-wider text-sm transition-all duration-300 ml-6"
              asChild
            >
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative w-full aspect-[3/4] rounded-xl overflow-hidden border border-border bg-secondary shadow-sm">
